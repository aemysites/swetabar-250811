...
## Environments
- Preview: https://main--swetabar-250811--aemysites.aem.page/
- Live: https://main--swetabar-250811--aemysites.aem.live/
...
1. Open the `swetabar-250811` directory in your favorite IDE and start coding :)
